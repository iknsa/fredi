...
class LoadAssociationUser extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $associationUser4->setAssociation($this->getReference('association-1'));
        ...
        $associationUser5->setAssociation($this->getReference('association-2'));
        ...
        $associationUser6->setAssociation($this->getReference('association-3'));
